...
onMounted(() => {
  ...
  // Available Balance set in local storage
  if ( localStorage.getItem('availableBalance') === null ){
    localStorage.setItem('availableBalance', 91220.18);
  }

  // Transactions set in local storage
